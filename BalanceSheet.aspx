<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BalanceSheet.aspx.cs" Inherits="UC_LIVE.BalanceSheet" %>
...
<style type="text/css">
		...
		<table style="width: 54%; height: 448px; margin: 0 auto;">
			...
			<tr>
				<td class="style6">
					...
					<div id="ViewContactInfo" runat="server" style="width:480px; float:left; margin-bottom:30px; margin-left:40px; text-align:left;  font-size:12px; ">
					</div>
					<div id="InvoiceNumber" runat="server" style="width:200px; margin-left:10px; float:left; text-align:left;  font-size:14px; ">					</div>
	...
	<table><tr><td valign="middle" align="center"><div id="FooterValue" runat="server" style=" margin-left:170px;  margin-top:280px; width:900px; font-size:11px; text-align:center;"></div>
	</td></tr></table>
