<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="updateTemplate.aspx.cs" Inherits="UC_LIVE.updateTemplate" %>
...
<table style="width:865px; height: 558px; margin-left:20px;" class="style8">
		...
		<div style="float:left; margin-left:-20px; padding-left:0px;">
				Update Template</div>
				
				<div style="margin-left:550px;float:left;">				<asp:HiddenField ID="TemplateIDHidden" runat="server" />
				<asp:Button ID="AddTemplateButton" runat="server" Text="Update Template" onclick="AddTemplateButton_Click"/></div>
		...
		<tr>
			...
			<td  >
				<label >
				Template Title<br />
				<asp:TextBox ID="TemplateTitle" runat="server" Width="289px" ></asp:TextBox>
			</td>
			<td  >
                </td>
		</tr>
