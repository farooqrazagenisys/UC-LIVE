<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewCarhireInvoice.aspx.cs" Inherits="UC_LIVE.ViewCarhireInvoice" %>
   ...
   <form id="form1" runat="server">
	<div id="maindiv" style="text-align:left; font-family:Arial;margin: 0 auto; height:1157px; ">
		<table style="margin: 0 auto;">
			<tr>
				...
				<div id="DocumentHeader" runat="server"></div>
					...
					<div id="ViewCompanyAddress" runat="server" style="font-size:12px; text-align:center" >
					</div>
			</tr>
			<tr>
				<td style="height: 5px;">
			...
			<tr><td style="margin-top:15px;">&nbsp;&nbsp;</td></tr>
		...
		<div id="InvoiceType" runat="server" 
                        style="width:765px; margin-bottom:25px; text-align:center; height:28px; font-size:33px; font-weight:bold; font-family:Times New Roman;">
					</div>
					
					<div id="ViewTitle" runat="server" 
                        style="width:785px; background-color:#1f3b8e; color:WHITE; font-weight:bold; margin-right:10px; margin-top:15px; margin-bottom:3px; padding-top:7px; text-align:center; height:35px; font-size:34px; font-family:Times New Roman; font-size:25PX;">
					</div>
				<%--<div id="ViewHeader" runat="server" 
                        style="width:785px; height:40px; font-size:14PX; font-family:Times New Roman">
					</div>--%>
				</td>
			</tr>
				<tr class="style6">
				...
				<td colspan="3" align="center" style="text-align: left;">
					<asp:GridView ID="GridView1" CssClass="GridView1" runat="server" 
						...
						<Columns>
							...
							<asp:ButtonField ControlStyle-Width="10"  /><asp:ButtonField />
                           
							<asp:BoundField DataField="Details" HeaderText="Details" SortExpression="Details"  ControlStyle-CssClass="ColumnSize" ItemStyle-Height="35" ItemStyle-Width="500"  ControlStyle-Width="400">


                            </asp:BoundField>
                            		<asp:ButtonField ControlStyle-Width="5"  /><asp:ButtonField />
                           
						<asp:BoundField DataField="NoOfDays" HeaderText="No of Days" SortExpression="NoOfDays" ItemStyle-Width="80">

                            </asp:BoundField>
					<asp:BoundField DataField="Rate" HeaderText="Daily Rate" SortExpression="Rate" DataFormatString="{0:C}" ItemStyle-Width="100" >													

                            </asp:BoundField>
							<asp:BoundField DataField="Amount" HeaderText="Total Amount" SortExpression="Amount" DataFormatString="{0:C}" ItemStyle-Width="100" >
				...
				<td colspan="3" class="style2" valign="top">
					<table style="width: 778px; height: 81px" border="0" cellpadding="0" cellspacing="0"  >
						<tr >
							...
							<td class="style5" style=" height:25px;"  valign="top">
						...
						<tr >
								...
								<tr id="ViewAmountDueText" runat="server" style=" height:10px;" >
							<td class="style11">
								&nbsp;</td>
							<td>
								&nbsp;</td>
							...
							<td><div id="ViewAmountDue" runat="server" style="background-color:Gray;" >
								</div>
						...
						<div id="FooterValue" runat="server" style=" margin-top:135px; font-size:10px; text-align:center; width:800px;"></div>
