<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewStorageInvoice.aspx.cs" Inherits="UC_LIVE.ViewStorageInvoice" %>
	...
	<div id="maindiv" style="text-align:left; font-family:Arial;margin: 0 auto; height:1157px;">
		...
		<div id="InvoiceType" runat="server" 
					...
					<div id="ViewTitle" runat="server" 
                        style="width:785px; background-color:#1f3b8e; color:WHITE; font-weight:bold; margin-right:10px; margin-bottom:5px; padding-top:7px; text-align:center; height:35px; font-size:34px; font-family:Times New Roman; font-size:25PX;">
					</div>
					<br />
				...
				<td colspan="3" align="center" style="text-align: left;">
					<asp:GridView ID="GridView1" CssClass="GridView1" runat="server" 
						...
						<Columns>
							...
							<asp:BoundField DataField="Details" HeaderText="Details" SortExpression="Details"  ControlStyle-CssClass="ColumnSize" ItemStyle-Height="35" ItemStyle-Width="400"  ControlStyle-Width="400">
...
<div id="FooterValue" runat="server" style="margin-bottom:0px; margin-top:180px; font-size:10px; text-align:center; width:800px;"></div>
				</td>
			</tr>
		</table>
	</div>
