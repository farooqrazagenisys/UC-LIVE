<%@ Page Title="" Language="C#" MasterPageFile="~/UserView.Master" AutoEventWireup="true" CodeBehind="userclaimlist1.aspx.cs" Inherits="UC_LIVE.userclaimlist1" %>
    ...
    <div style="margin-bottom: 10px; width: 948px; background-color: White; border: solid 1px buttonface;">
        <div class="MainHeading">
            Claim Details <span style="font-size: 11px; padding-left: 11px;">To save your data at
                any time go to step 7 (Save Claim) and click save </span>
            <br />
            <br />
                    ...
                    <table style="width: 880px; vertical-align: top; margin-left: 20px; height: 60px;
                        ...
                        <tr>
                            ...
                            <td id="RoadConditionsTd" runat="server" class="style8" style="padding-bottom: 10px;
                                ...
                                <div style="padding-bottom: 6px; padding-top: 8px; width: 100px;">
                                    Road Condition</div>
                            ...
                            <td class="style8">
                                <label>
                                    Accident Location</label><asp:TextBox ID="AccidentLocation" runat="server" Width="115"></asp:TextBox>
                            </td>
                              <td class="style8" >
