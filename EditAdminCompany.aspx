<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="EditAdminCompany.aspx.cs" Inherits="UC_LIVE.EditAdminCompany" %>
...
<div style="background-color:White; width:100%;  >
	...
	<table style="width:287px; height: 398px;">
     ...
     <tr><td class="style1" colspan="2"><h3>Admin Account Details</h3></td></td></tr>
	...
	<br />
			 <asp:TextBox ID="CompanyTextBox" runat="server" Height="25px" Width="210px"></asp:TextBox>
...
<td colspan="2">
	<asp:TextBox ID="BankDetailsTextBox" runat="server" Height="93px" Width="397px" TextMode="MultiLine"></asp:TextBox>
...
<td colspan="2">
	<asp:TextBox ID="CompanyInfoTextBox" runat="server" Height="93px" Width="397px" TextMode="MultiLine"></asp:TextBox>
